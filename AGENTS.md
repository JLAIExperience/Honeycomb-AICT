...
Guidance for AI coding agents working in **James Test App**.
...
1. Invoke the `component-discovery` skill first — before writing any code or making a plan.
2. If a reusable candidate exists, use the best match and proceed. Mention what you chose in your response, but do not stop to ask for confirmation.
3. Only after steps 1–2, edit files under `pages/` or `components/`.

Use the ServiceNow AIUX skills before changing app code:

- `component-discovery` — see Mandatory UI Edit Checklist above
